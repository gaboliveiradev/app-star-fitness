...
export default function MyExercises() {
    ...
    const handleFilterSearchText = async (event) => {
        ...
        const newData = exerciseList.filter(row => {
    ...
    const columns = [
        ...
        {
            name: <span className='font-bold text-[14px]'>Grupo Muscular</span>,
            selector: row => <span className='text-[14px]'>{row.muscle_groups}</span>,
            sortable: true
        },
        {
            ...
            <div>
                <div className="flex-auto pb-[14px]">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="divider">/</li>
                        <li><span class="active">Exercícios</span></li>
                        <li class="divider">/</li>
                        <li><span class="active">Gerenciar Exercícios</span></li>
                    </ul>
                </div>
            </div>

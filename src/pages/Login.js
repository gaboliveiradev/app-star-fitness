    ...
    <div class="bg-white dark:bg-gray-900">
      <div class="flex justify-center h-screen">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://imgur.com/ZMjDYeO.png)",
          }}
        >
              ...
              {stepper === 1 ? (
                ...
                <form>
                  ...
                  <div>
                    ...
                    <button
                      onClick={() =>
                        setStepper(stepper === 3 ? 2 : stepper + 1)
                      }
                    ...
                    <div className="mt-[20px] flex flex-col items-center">
                      <a
                        onClick={() =>
                          setStepper(stepper === 2 ? 1 : stepper - 1)
                        } // Alterna para o formulário de recuperação de senha
                        class="cursor-pointer text-sm text-blue-600 focus:text-blue-500 hover:text-blue-500 hover:underline"
                      >
                          ...
                          <div className="flex flex-col space-y-16">
                            ...
                            <div className="flex flex-col space-y-5">
                              <div>
                                <button
                                  onClick={() =>
                                    setStepper(stepper === 3 ? 4 : stepper + 1)
                                  }
                              ...
                              <div className="mt-[20px] flex flex-col items-center">
                                <a
                                  onClick={() =>
                                    setStepper(stepper === 3 ? 1 : stepper - 1)
                                  } // Alterna para o formulário de recuperação de senha
                                  class="cursor-pointer text-sm text-blue-600 focus:text-blue-500 hover:text-blue-500 hover:underline"
                                >
                                  Voltar a tela de Login
                  ...
                  <div>
                    ...
                    <div className="mt-[20px]">
                      ...
                      <div className="mt-[20px] flex flex-col items-center">
                        <a
                          onClick={() =>
                            setStepper(stepper === 4 ? 1 : stepper - 1)
                          } // Alterna para o formulário de recuperação de senha
                          class="cursor-pointer text-sm text-blue-600 focus:text-blue-500 hover:text-blue-500 hover:underline"
                        >
                          Voltar a tela de Login
